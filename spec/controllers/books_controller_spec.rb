...
RSpec.describe BooksController do
    ...
    describe "GET #index" do
        let(:books) { [instance_double(Book), 
        ...
        it "look up all books that belong to the current user" do
    ...
    describe "POST #create" do
        ...
        context "when the book is successfully saved" do
            ...
            it "redirect to the book show page with flash message" do
                expect(flash[:notice]).to eq("Book was successfully created.")  
            end
        end

        context "When the book is not saved" do
            before do
    ...
    describe "PATCH #update" do
        ...
        context "when the update succeed" do
